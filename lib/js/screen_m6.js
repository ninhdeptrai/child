let fn06 = function () {
    (function () {
        const slide = $('.slide');
        const text = $('.screen-m6 .body .text p');
        const elSubmit = $('.screen-m6 #button-submit');
        const elTop = $('.screen-m6 .top');
        const stars = `<img src="./lib/images/M5_new/sao.png" alt="">`;
        const buttonAudio = $('.screen-m6 .audio img');
        const elStart = $('.screen-m6 .btn-play img');
        ...
        elStart.on('click', function (e){
            start();
            musicBackground = playAudio('lib/images/M6_new/voice/nen.mp3');
            playAudio(dataAudio[result - 1]);
            $('.screen-m6 .btn-play').hide();
        })
        ...
        buttonAudio.on('click', function (e) {
            playAudio(dataAudio[result - 1]);
        })
...
document.addEventListener("DOMContentLoaded", fn06);